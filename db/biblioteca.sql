...
--
-- Servidor: localhost
-- Tiempo de generación: 23-01-2026 a las 20:47:44
...
CREATE TABLE `editorial` (
  ...
  `nombre_editorial` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `escritores` (
  ...
  `nombre_escritor` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
(3, 'Kate', 'Stewart', 'Estadounidense', 1, '2026-01-23'),
...
CREATE TABLE `nacionalidad` (
  ...
  `nombre_nacionalidad` varchar(100) COLLATE utf8mb3_spanish_ci NOT NULL
...
INSERT INTO `prestamos` (`id_prestamo`, `id_libro`, `id_usuario`, `fecha_prestamo`, `fecha_devolucion_prevista`, `fecha_devolucion_real`, `fecha_capturada`) VALUES
(1, 3, 1, '2026-01-23', '2026-01-28', '2026-01-28', '2026-01-23 12:48:15'),
(2, 173, 1, '2026-01-23', '2026-01-30', '2026-01-30', '2026-01-23 12:41:33'),
(3, 169, 2, '2026-01-23', '2026-01-30', '2026-01-30', '2026-01-23 12:42:15'),
(4, 137, 3, '2026-01-23', '2026-01-30', '2026-01-30', '2026-01-23 12:51:04'),
(5, 99, 3, '2026-01-23', '2026-01-30', '2026-01-30', '2026-01-23 12:55:48');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `email`, `telefono`, `direccion`, `fecha_nacimiento`) VALUES
(1, 'Alberto', 'Bernal Ramírez', 'smb34abr@gmail.com', '5534219902', 'José María Morelos 79-4, Barrio del niño Jesus, Ciudad de México.', '1969-06-10'),
(2, 'María Emelia', 'Tejeda romero', 'melytejeda31@hotmail.com', '5516481486', 'José María Morelos 79-4, Barrio del niño Jesus, Ciudad de México.', '1981-01-05'),
(3, 'Sebastián', 'Bernal Tejeda', 'sbernal@gmail.com', '5513323325', 'José María Morelos 79-4, Barrio del niño Jesus, Ciudad de México.', '2015-05-23');
...
--
ALTER TABLE `editorial`
  MODIFY `id_editorial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `escritores`
--
ALTER TABLE `escritores`
  MODIFY `id_escritor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT de la tabla `libros`
--
ALTER TABLE `libros`
  MODIFY `id_libro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;

--
-- AUTO_INCREMENT de la tabla `nacionalidad`
--
ALTER TABLE `nacionalidad`
  MODIFY `id_nacionalidad` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `prestamos`
--
ALTER TABLE `prestamos`
  MODIFY `id_prestamo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
